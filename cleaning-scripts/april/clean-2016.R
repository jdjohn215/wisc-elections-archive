...
# the april 2016 nonpartisan (spring) general election
orig.path <- "original-data/april/Supreme_20Court_20Ward_20by_20Ward_20AMENDED_20Report-Brown_20Co_2016.xlsx"

# the workbook holds only the JUSTICE OF THE SUPREME COURT contest
...
sheets.2016 <- lapply(seq_along(readxl::excel_sheets(orig.path)), read_sheet_long)
...
results.2016 |> count(office, candidate, wt = votes)
