...
s1 <- readxl::read_excel("original-data/nonpartisan/2017_20Spring_20Election-Supreme_20Court-Ward_20Report_2017.xlsx",
...
s2 <- s1 |>
  ...
  mutate(party = case_when(
    candidate == "Annette Ziegler" ~ "conservative",
    TRUE ~ "Scattering"
  )) |>
...
write_csv(s2, "processed-data/nonpartisan/annual/2017.csv")
