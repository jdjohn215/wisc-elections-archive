...
s1 <- readxl::read_excel("original-data/nonpartisan/2011-04-05_Ward_results_supreme_recount_2011.xls",
...
write_csv(s2, "processed-data/nonpartisan/annual/2011.csv")
