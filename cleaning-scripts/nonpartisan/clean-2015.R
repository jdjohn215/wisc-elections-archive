...
s1 <- readxl::read_excel("original-data/nonpartisan/Ward_20Results_204.7.15_20Spring_20Election_2015.xlsx",
...
s2 <- s1 |>
  ...
  mutate(party = case_when(
    candidate == "JAMES P. DALEY" ~ "conservative",
    candidate == "ANN W. BRADLEY" ~ "liberal",
    TRUE ~ "Scattering"
  )) |>
...
write_csv(s2, "processed-data/nonpartisan/annual/2015.csv")
