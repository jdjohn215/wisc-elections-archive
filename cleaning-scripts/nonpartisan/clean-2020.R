...
s1 <- readxl::read_excel("original-data/nonpartisan/Ward_20by_20Ward_20Report_Supreme_20Court_2020.xlsx",
...
s2 <- s1 |>
  ...
  mutate(party = case_when(
    candidate == "Jill J. Karofsky" ~ "liberal",
