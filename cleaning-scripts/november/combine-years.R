...
all.files <- map_df(list.files("processed-data/november/annual", full.names = T, pattern = "[0-9].csv"),
                    read_csv)
...
#   by reporting unit
write_csv(clean.results.with.fips.valid, "processed-data/november/AllElections_ReportingUnit.csv")
# 
