...
orig.sheets <- readxl::excel_sheets("original-data/november/Ward by Ward Report_November 5 2024 General Election_Federal and State Contests.xlsx")
...
read_sheet <- function(sheetindex){
  ...
  s1 <- readxl::read_excel("original-data/november/Ward by Ward Report_November 5 2024 General Election_Federal and State Contests.xlsx",
...
write_csv(all.2024.2, "processed-data/november/annual/2024.csv")
